      ...
      >
        <header className="structure-header">
          <div>
            ...
            <p>
              ستُبنى بنية هذا النوع من
              المشاريع عند تطوير الفصول
              والوحدات الدرامية.
            </p>
          </div>
        </header>
        ...
        <section className="structure-unavailable">
          وحدة المواسم والحلقات مخصصة
          حاليًا للمسلسل والحلقة
          المنفردة.
        </section>
      </main>
    );
    ...
    >
      <header className="structure-header">
        <div>
          ...
          <p>
            تنظيم البنية العامة وكتابة
            ملخصات الحلقات ومتابعة
            حالتها.
          </p>
        </div>

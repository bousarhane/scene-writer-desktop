...
export class ProjectService {
  ...
  async createProject(
    ...
    const seriesStructure =
      normalizeSeriesStructure(
        projectType,
        input.seriesStructure ??
          null,
      );

    const plannedSeasonCount =
      normalizeSeasonCount(
        projectType,
        seriesStructure,
...
function normalizeSeriesStructure(
  projectType: ProjectType,
